...
#ifdef GSC_FIXED
typedef S64                 GSC_S64_T;
typedef S32                 GSC_S32_T;
typedef S16                 GSC_S16_T;
#else
...
typedef VOID (*GSC_FUNCHOOK_T)(VOID *, S32, CONST BYTE *, S32);
...
typedef struct tagGSC_Api
{
    ...
    CONST GSC_S32_T   *psHanningWind; /* Used for fft window. */
    VOID              *pvUsrData;
    GSC_FUNCHOOK_T     pfuncGscOutputHook;
    AISP_FFT_ENGINE_S *pstFFTEng;
    AISP_FFT_ENGINE_S *pstIFFTEng;
