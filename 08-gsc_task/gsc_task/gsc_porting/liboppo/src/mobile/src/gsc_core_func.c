...
************************************************************/
S32 fftInit(AISP_FFT_ENGINE_S **pstFftEng, AISP_FFT_ENGINE_S **pstIFftEng, S32 fftSize)
{
    *pstFftEng = AISP_fft_new(FALSE, fftSize, 24, 15);
    *pstIFftEng = AISP_fft_new(TRUE, fftSize, 15, 24);
    return 0;
}
...
************************************************************/
VOID fftDelete(AISP_FFT_ENGINE_S *pstFftEng, AISP_FFT_ENGINE_S *pstIFftEng)
{
    AISP_fft_delete(pstFftEng);
    AISP_fft_delete(pstIFftEng);
}
...
************************************************************/
S32 fftProcess(GSC_Api_S *pstGscApi, CONST BYTE *pcData)
{
    ...
    if (pstGscApi->pstGscCfg->bInited)
    {
        switch (GSC_MICS)
        {
        case 2:
        {
            ...
            for (sLoop = 0; sLoop < GSC_FRMINC; sLoop++, psRaw += GSC_IN_CHAN)
            {
                ...
                *(pMic1Raw + GSC_FRMINC) = PSHR((S64)(*pHanningBtm) * (*psRaw),
                                                AISP_TSL_Q22_SHIFT);/* W32Q24 = Q31xQ15 >> 22 */
                *(pMic2Raw + GSC_FRMINC) = PSHR((S64)(*pHanningBtm) * (*(psRaw + 1)), AISP_TSL_Q22_SHIFT);
#else
            ...
            iRet = AISP_fft_feed(pstGscApi->pstFFTEng, aiRawData, pcpxMic1FFT);
            ...
            iRet = AISP_fft_feed(pstGscApi->pstFFTEng, aiRawData + GSC_FRMLEN, pcpxMic2FFT);
        ...
        default:
            AISP_TSL_printf("%s", "Not support. Please check the configuration.\n");
            return -1;
        }
    }
    else
    {
        pstGscApi->pstGscCfg->bInited = TRUE;
        iRet = 1;
    }
    ...
    case 2:
    {
        ...
        {
#ifdef GSC_FIXED
            *pMic1LeftRaw++ = PSHR((S64)(*psHanningWin) * (*psRaw),     AISP_TSL_Q22_SHIFT);/* W32Q24 = Q31xQ15 >> 22 */
            *pMic2LeftRaw++ = PSHR((S64)(*psHanningWin) * (*(psRaw + 1)), AISP_TSL_Q22_SHIFT);
            psHanningWin++;
#else
...
S32 fftProcessParallel(GSC_Api_S *pstGscApi, S8 *pcChan1, S8 *pcChan2)
{
...
#ifdef GSC_FIXED
                /* raw data is 32Q24 for 512 points fft */
                *(pMic1Raw + GSC_FRMINC) = PSHR((S64)(*pHanningBtm) * (*psRaw1), AISP_TSL_Q22_SHIFT);
                *(pMic2Raw + GSC_FRMINC) = PSHR((S64)(*pHanningBtm) * (*psRaw2), AISP_TSL_Q22_SHIFT);
#else
    ...
    case 2:
    {
        ...
        {
#ifdef GSC_FIXED
            *pMic1LeftRaw++ = PSHR((S64)(*psHanningWin) * (*psRaw1), AISP_TSL_Q22_SHIFT);
            *pMic2LeftRaw++ = PSHR((S64)(*psHanningWin) * (*psRaw2), AISP_TSL_Q22_SHIFT);
            psHanningWin++;
#else
...
S32 gscUpdateVAD(GSC_Api_S *pstGscApi, GSC_COMPLEX_T *pcpxY)
{
    ...
    for (iBins = 0; iBins < GSC_FFTBINS; iBins++)
    {
        pllMicAbsBin[iBins] = (S32)(pfMic1Dst[iBins] + 0.5);
    ...
    {
#ifdef GSC_FIXED
        *pllMic1Power = (S64)pcpxMic1->real * pcpxMic1->real + (S64)pcpxMic1->imag *
                        pcpxMic1->imag;/* Fixed: W64Q30 = Q15xQ15 */
#ifndef FULLZEROJUDGEWAY
        *pllMic2Power = (S64)pcpxMic2->real * pcpxMic2->real + (S64)pcpxMic2->imag * pcpxMic2->imag;
...
#endif
    {
        ...
        if (pstGscCfg->iIdxExeFrm <= (5 + pstGscCfg->iIdxFstFrm_nonzero))
        {
            ...
            {
#ifdef GSC_FIXED
                *pllGscNoisePSD += PSHR_POSITIVE((S64)3355443 * (*pllMic1Power), 24);/* Fixed: W64Q24 += Q24xQ30/Q30 */
#else
        ...
        for (iBins = 0; iBins < GSC_FFTBINS; iBins++)
        {
            ...
            llTmp      = iLogGLRFact + PSHR_POSITIVE((S64)iGLRexp * llSnrPost1, 24);/* Fixed: Q24 = Q24 + Q24xQ24/Q24 */
...
#endif
#ifdef GSC_FIXED
            *piPH1mean = PSHR_POSITIVE((S64)iAlphaPH1mean * (*piPH1mean) + (S64)(16777216 - iAlphaPH1mean) *
            ...
            llTmp           = PSHR_POSITIVE((S64)(*piGscPH1) * (*pllGscNoisePSD) + (S64)(16777216 - *piGscPH1) *
                                            (*pllMic1Power), 24);/* W64Q24 */
            *pllGscNoisePSD = PSHR_POSITIVE((S64)iAlphaPSD * (*pllGscNoisePSD) + (S64)(16777216 - iAlphaPSD) * llTmp,
                                            24);/* W64Q24 */
#else
        ...
        {
#ifdef GSC_FIXED
            iTmp          = PSHR_POSITIVE((S64)(*piGscPH1) * (*piGscPH1_f), 24);
            *pllRefNewSum = AISP_TSL_sqrt_xW64_yW32((U64)iTmp * (*pllMic1Power));/* Fixed: Q24 = sqrt(Q48) */
#else
...
S32 gscUpdateHalfVAD(GSC_Api_S *pstGscApi, GSC_COMPLEX_T *pcpxY)
{
    ...
    GSC_S32_T *pllMicAbsBin  = (GSC_S32_T *)pstGscInst->pcpxRef1;
#endif
    GSC_S64_T *pllRefNewSum =
        NULL;                        /* Shared with pcpxMic1/pcpxMic2/pcpxRef1/pcpxRef2, be careful. */
    GSC_COMPLEX_T *pcpxMic1  = pcpxY;
    GSC_COMPLEX_T *pcpxMic2  = pcpxY + GSC_FFTBINS; /* Mic1 and mic2 data in frequency domain */
    GSC_S64_T *pllGscNoisePSD = pstGscInst->pGscNoisePSD;
    GSC_S32_T *piGscPH1      = pstGscInst->pGscPH1;
    GSC_S32_T *piPH1mean = NULL;
    /* Zone for immediate variable. */
    GSC_S64_T llMicAbsSum    = 0;
    GSC_S64_T llTmp          = 0;
    GSC_S64_T llSnrPost1     = 0;
...
#endif
    {
        ...
        if (pstGscCfg->iIdxExeFrm <= (5 + pstGscCfg->iIdxFstFrm_nonzero))
        {
            ...
            {
#ifdef GSC_FIXED
                *pllGscNoisePSD += PSHR_POSITIVE((S64)3355443 * (pllMic1Power[iBins]), 24);/* Fixed: W64Q24 += Q24xQ30/Q30 */
#else
        ...
        {
#ifdef GSC_FIXED
            iTmp          = PSHR_POSITIVE((S64)(*piGscPH1) * (*piGscPH1), 24);
            *pllRefNewSum = AISP_TSL_sqrt_xW64_yW32((U64)iTmp * (pllMic1Power[iBins]));/* Fixed: Q24 = sqrt(Q48) */
#else
...
#ifdef GSC_FIXED
#ifdef RVMATH
        mrv_add_ql((S32 *)pcpxMIC, (S32 *)pcpxMIC, (S32 *)pcpxMic2, iBinsOffset);
        mrv_add_ql((S32 *)pcpxREF, (S32 *)pcpxREF, (S32 *)pcpxRef2, iBinsOffset);
#else
        ...
        if (pstGscCfg->iAdaBM)
        {
            ...
            for (iBinIdx = 0; iBinIdx < GSC_FFTBINS; iBinIdx++)
            {
...
#ifdef GSC_FIXED
                llTmp         = (S64)pcpxMIC->real * pcpxMIC->real + (S64)pcpxMIC->imag *
                                pcpxMIC->imag;             /* W64Q30 = Q15xQ15 */
                *pllYPowerSum = PSHR_POSITIVE((S64)iTapsPSD * (*pllYPowerSum) + (S64)(AISP_TSL_Q15_ONE - iTapsPSD) * llTmp,
                ...
                *pllYPowerSum = iTapsPSD * (*pllYPowerSum) + (1.0 - iTapsPSD) * llTmp;
...
#ifdef GSC_FIXED
                icpxEST_U.real = PSHR((S64)pcpxMIC->real * pcpxH->real - (S64)pcpxMIC->imag * pcpxH->imag,
                                      24);/* Fixed: Q15 = Q15xQ24/Q24 */
                icpxEST_U.imag = PSHR((S64)pcpxMIC->real * pcpxH->imag + (S64)pcpxMIC->imag * pcpxH->real, 24);
#else
                ...
                /* Error power */
#ifdef GSC_FIXED
                llERR_U_POWER = (S64)icpxU.real * icpxU.real + (S64)icpxU.imag * icpxU.imag;/* W64Q30 = Q15xQ15 */
#else
                ...
                if (pstGscCfg->iVAD == 1)
                {
                    ...
                    //llcpxERR_U_PRE_NORM.real = PDIV64(((S64)icpxU.real << 39), (llTmp + 1));/* Q24 = (Q15 << 39)/Q30 */
                    //llcpxERR_U_PRE_NORM.imag = PDIV64(((S64)icpxU.imag << 39), (llTmp + 1));/* Same with matlab */
#else
...
#ifdef GSC_FIXED
                    icpxEST_U.real = PSHR((S64)llcpxERR_U_PRE_NORM.real * pcpxMIC->real + (S64)llcpxERR_U_PRE_NORM.imag *
                                          pcpxMIC->imag, 15);
                    icpxEST_U.imag = PSHR((S64)llcpxERR_U_PRE_NORM.imag * pcpxMIC->real - (S64)llcpxERR_U_PRE_NORM.real *
                                          pcpxMIC->imag, 15);
#else
...
#endif
#ifdef GSC_FIXED
                    pcpxH->real += PSHR((S64)iMu * icpxEST_U.real, 24);
                    pcpxH->imag += PSHR((S64)iMu * icpxEST_U.imag, 24);
#else
                ...
                /* X_POWER_SUM */
#ifdef GSC_FIXED
                *pllXPowerSum = PSHR_POSITIVE((S64)iTapsPSD * (*pllXPowerSum), 15) + llERR_U_POWER;
#else
...
#ifdef GSC_FIXED
                llERR_U_POWER = (S64)pcpxREF->real * pcpxREF->real + (S64)pcpxREF->imag * pcpxREF->imag;
                *pllXPowerSum = PSHR_POSITIVE((S64)iTapsPSD * (*pllXPowerSum), 15) + llERR_U_POWER;
#else
...
//              *pllXPowerSum = iTapsPSD * (*pllXPowerSum) + (1.0 - iTapsPSD) * llERR_U_POWER;
...
#ifdef GSC_FIXED
#ifdef RVMATH
        mrv_sub_ql((S32 *)pcpxTmp, (S32 *)pcpxMIC, (S32 *)pcpxEST, iBinsOffset);
#else
    ...
    if (pstGscCfg->iVAD == 0)
    {
        ...
        for (iBeamIdx = 0; iBeamIdx < iGscNum; iBeamIdx++)
        {
            ...
            {
#ifdef GSC_FIXED
                llERR_POWER = (S64)pcpxTmp->real * pcpxTmp->real + (S64)pcpxTmp->imag * pcpxTmp->imag;
                llTmp = (*pllXPowerSum) + (S64)iTapsDalta * llERR_POWER;/* W64Q30 */
#else
                ...
                llTmp = (((S64)1 << 60) + ((llTmp + 1) >> 1)) / (llTmp + 1); /* Q30 = (Q60 + Q30/2)/Q30 */
                pcpxErrPreNorm->real = PSHR((S64)pcpxTmp->real * llTmp, 21); /* Q24 = Q15 * Q30 >> 21 */
                pcpxErrPreNorm->imag = PSHR((S64)pcpxTmp->imag * llTmp, 21);
#else
...
VOID dataPop(GSC_Api_S *pstGscApi, VOID *pvData)
{
    CONST GSC_S32_T     *psHannWindow  = NULL;
    ...
    for (iGscIdx = 0; iGscIdx < iGscNum; iGscIdx++)
    {
        piOut        = aiOut;
        pcpxTop      = &acpxSe[1];
        pcpxBtm      = &acpxSe[GSC_FFTBINS];
        psHannWindow  = pstGscApi->psHanningWind;
        pcpxEntBlock = ((GSC_COMPLEX_T *)pvData) + GSC_FFTBINS * iGscIdx;
        ...
        /* do iFFT */
        if (0 != AISP_fft_feed(pstGscApi->pstIFFTEng, acpxSe, piOut))
        {
            return;
        }
        ...
        {
#ifdef GSC_FIXED
            *piOut = PSHR((S64) * piOut * *psHannWindow, AISP_TSL_Q31_SHIFT);
            piOut++;
            psHannWindow++;
#else
        ...
        if (pstGscApi->pfuncGscOutputHook)
        {
            pstGscApi->pfuncGscOutputHook(pstGscApi->pvUsrData, iGscIdx, (BYTE *)aFixedOut, GSC_FRMINC << 1);
        }
    }
}
#endif
...
STATIC VOID rdmaLinearConv(GSC_S32_T *piX, GSC_S32_T *piFilter, GSC_S32_T *piY, S32 iXLen, S32 iFilterLen, S32 iYLen)
{
    ...
    for (iLoop1 = 0; iLoop1 < iYLen; iLoop1++)
    {
        ...
        *piY++ = (llYSum + (1 << 30)) >> 31;/* Attention: If FilterLen is too large, llYSum will be overflow! */
        llYSum = 0;
    }
